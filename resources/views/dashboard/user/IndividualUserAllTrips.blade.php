...
@section('content')
    <div class="container">
        <form action="{{ route('admin.showIndividualUsergTrip',['id' => $user_id]) }}" method="GET" class="mb-3">
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('admin.showIndividualUsergTrip',['id' => $user_id]) }}" class="btn btn-secondary">Reset</a>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Travel ID: {{ $booking->id }}</p>
                            <a href="{{ route('admin.booking.details', ['travel_id' => $booking->id]) }}" class="btn btn-primary">Details</a>
                        </div>
                    </div>
                </div>
            @endforeach
