...
@section('content')
    <div class="container">
        <form action="{{ route('admin.showIndividualStaffUpcomingTrip',['id'=>$staff_id]) }}" method="GET" class="mb-3">
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('admin.showIndividualStaffUpcomingTrip',['id'=>$staff_id]) }}" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>
