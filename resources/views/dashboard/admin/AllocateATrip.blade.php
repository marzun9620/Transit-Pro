...
@section('content')
  <head>
    <h2 class="text-center title">Create New One Day Trip</h2>
    ...
    <div class="modal" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="errorModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('buses.trip.create.added') }}">
                        @csrf
        ...
        <div class="col-md-4">
            <div class="card sidebar">
                ...
                <div class="card-body sidebar-container">
                    <form action="{{ route('buses.trip.create.allocate') }}" method="GET">
                        <div class="form-group">
            ...
            <div class="card sidebar">
                ...
                <div class="card-body sidebar-container">
                    <form action="{{ route('buses.trip.create.freeStaff') }}" method="GET">
                        <div class="form-group">
